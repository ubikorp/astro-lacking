...
export const headerData = {
  links: [
    ...
    {
      text: 'Playlists',
      href: getPermalink('playlists', 'category'),
    },
    {
      text: 'Radio&nbsp;Activity',
...
export const footerData = {
  ...
  socialLinks: [
    ...
    { ariaLabel: 'Mixcloud', icon: 'tabler:cloud', href: 'https://www.mixcloud.com/the-lacking-org/' },
    { ariaLabel: 'Instagram', icon: 'tabler:brand-instagram', href: 'https://www.instagram.com/jclacking' },
    { ariaLabel: 'Facebook', icon: 'tabler:brand-facebook', href: 'https://www.facebook.com/jclacking' },
